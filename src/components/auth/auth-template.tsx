...
export default function AuthTemplate({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen flex-col bg-white dark:bg-black md:h-screen md:flex-row-reverse">
      <section className="mx-auto flex w-full items-start px-8 md:w-1/3 md:items-center md:px-0">
        <div className="relative mx-auto my-auto flex w-full min-w-min max-w-sm origin-left transform flex-row items-center py-4 pt-4 md:-left-4 md:mx-0 md:py-4">
          <div className="flex items-center bg-white py-8 dark:bg-black">
            <Logo />
          </div>
        </div>
      </section>
      <section className="justify-center border-black px-8 dark:border-white md:flex md:w-2/3 md:border-r md:px-0">
